...
import { CheckCircle2, XCircle, Camera, Activity, Cpu } from 'lucide-react';

export default function ExecutionMonitor({ isExecuting, currentStep, executionResults, finalReport, isMcpConnected }) {
    ...
    <div className="space-y-6">
      ...
      <div className="glass-panel rounded-2xl p-4 sm:p-6 border border-emerald-500/20">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-4">
          ...
          {/* Quick Metrics */}
          <div className="grid grid-cols-3 gap-2 sm:gap-3 w-full sm:w-auto sm:flex items-center">
